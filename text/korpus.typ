...
Cílem této práce bylo prostřednictvím modelů rozšíření druhů popsat vztahy mezi výskytem 6 západobalkánských horských rostlin a dostupnými environmentálními prediktory a tyto vztahy následně využít k prostorovým projekcím vhodnosti stanovišť v současných, minulých a hypotetických budoucích podmínkách. Napříč studovanými druhy se podařilo shromáždit variabilní množství výskytových dat, která se lišila svým původem a prostorovým rozložením. Výsledky ukazují, že rozšíření studovaných druhů lze do různé míry vysvětlit kombinací zvolených prediktorů, ale výsledky se liší mezi jednotlivými druhy i velikostmi _grain_. Projekce odvozených vztahů očekávatelně ukazují na ostrůvkovité rozšíření vhodných stnovišť v prostoru, lokalizované v nejvyšších partiích západobalkánských pohoří, zatímco projekce do posledního glaciálního maxima naznačují více propojené areály s významnějším ústupem v období holocénního klimatického optima. Projekce do budoucích environmentálních podmínek vykazují trend zmenšování a významnější fragmentace vhodných stanovišť v prostoru. Ačkoli variabilita ve strukturách projekcí mezi jednotlivými velikostmi _grain_ není nijak zásadní, mezi jednotlivými druhy zůstává vysoká. Stejně tak se výrazně liší predikční výkonost jendotlivých modelů napříč druhy a velikostmi _grain_. Porovnání prostorových rozlišení nepotvrdilo existenci jednoho obecně optimálního měřítka, jelikož některé druhy byly lépe modelovány v jemnějších a jiné v hrubších zrnech. Metrika Shape zároveň ukázala, že míra opory projekcí v trénovacích datech je v prostoru a mezi časovými řezy různá, poměrně dobrou oporu mají predikce vhodných stanovišť na současných environmentálních podmínkách, zatímco projekce v čase vykazují o řád vyšší míru environmentální novosti.

== _Gentiana dinarica_

Pro modelování rozšíření _Gentiana dinarica_ bylo v závislosti na prostorovém rozlišení dostupných 32 až 49 presenčních a 240 až 552 absenčních pozorování, přičemž všechny presence pocházely z vlastního terénního průzkumu. V modelovací větvi trénované na společných prediktorech a na všech dostupných prediktorech patřily mezi nejvýznamnější prediktory především _minimální teplota nejchladnějšího měsíce_ (bio06), _roční úhrn srážek_ (bio12), _srážky nejsuššího měsíce_ (bio14) a dále _hloubka půdy_, _vodní kapacita půdy_ a _krajinný pokryv_. Křivky odpovědí ukazují vyšší vhodnost stanovišť na lokalitách s nízkou minimální zimní teplotou a vyšším úhrnem srážek v průběhu roku i nejsuššího měsíce. Z půdních charakteristik byly jako vhodnější hodnoceny oblasti s mělčí půdou, avšak nikoli půdy s nejnižší schopností zadržovat vodu. Celkový příspěvek krajinného pokryvu stoupal se snižujícícm se rozlišením, přičemž nejvyšší predikované vhodnost spadala do kategorie 30 (_Grassland_). Ve větvi určené pro časové projekce byly výše zmíněné bioklimatické prediktory nahrazeny _průměrnou roční teplotou_ (bio10) a _srážkami nejteplejšího období_ (bio18). Tyto prediktory však naznačovaly analogiský vztah, kdy vhodnost stanoviště vzrůstala se snižující se průměrnou roční teplotou a zvyšujícícmi se srážkami.

Projekce na současné podmínky porstředí lokalizovaly nejvyšší vhodnost do izolovaných horských oblastí centrálních a jihovýchodních Dinarid, navazujících západobalkánských pohoří a středně vysokou vhodnost stanovišť predikovaly i v severozápadní části studované oblasti. Na druhou stranu nížiny a i vyšší polohy na jihovýchodě oblasti byly predikovány jako nevhodné. Tento základní prostorový vzorec byl stabilní napříč modelovacími větvemi i prostorovými rozlišeními a jemnější modely dále rozdělovaly vhodné horské celky do podrobnější mozaiky. Projekce se tak dobře shodují s dosavadní znalostí západobalkánské části areálu.

/*Plants of the World Online uvádí přirozený výskyt taxonu, vedeného zde jako *Gentiana acaulis* subsp. *dinarica*, na západním Balkáně, v Albánii a ve střední Itálii a charakterizuje jej jako vytrvalou rostlinu subalpinského až subarktického biomu. Také nová studie balkánských zástupců sekce *Ciminalis* dokládá výskyty *G. dinarica* v západní a centrální části Balkánu, mimo jiné v Bosně a Hercegovině, a současně upozorňuje, že přesné taxonomické vymezení druhu a jeho vztah k *G. acaulis* nejsou zcela ustálené.*/

Zahrnutí půdních proměnných a krajinného pokryvu vedlo ve srovnání s časově extrapolovatelnou větví ke zvýšení diskriminační schopnosti ve třech ze čtyř prostorových rozlišení. Somersovo D se při 1000 m zvýšilo z 0,671 na 0,733, při 200 m z 0,453 na 0,597 a při 100 m z 0,616 na 0,702; pouze při 500 m zůstalo prakticky neměnné. Zlepšení bylo tedy nejvýraznější v rozlišení 200 m, zatímco u nejúspěšnějšího časově extrapolovatelného modelu (500 m) nepřinesly dodatečné proměnné téměř žádný přínos. Toto naznačuje, že půdní podmínky a krajinný pokryv mohou pomáhat rozlišit lokální vhodnost uvnitř klimaticky vhodných horských oblastí, avšak základní regionální rozmístění druhu je již poměrně dobře určeno klimatem, topografií a podložím. Zde je však nutné zdůraznit, že výsledek není radno interpretovat jako čistý vliv půdních a vegetačních prediktorů, jelikož mezi větvemi a rozlišeními částečně měnilo i složení ostatních prediktorů. Celkově dosahovaly nejlepší současné modely Somersova D přibližně 0,72–0,73.

// dalej

Pro časové projekce byl jako nejúspěšnější vybrán model v rozlišení 500 m se Somersovým D 0,721. Jeho křivky odpovědí spojovaly vhodnost především s chladnějšími letními podmínkami a vyššími srážkami během teplého a suchého období, což poskytuje ekologicky konzistentní vysvětlení časových změn projekcí. Během posledního glaciálního maxima model předpovídal širší a prostorově spojitější pás vhodných podmínek napříč Dinaridy než v současnosti. Tento výsledek je slučitelný s možností, že chladnomilný horský druh mohl během glaciálu sestoupit do nižších poloh a že dnes izolované horské oblasti byly propojeny větší rozlohou klimaticky vhodného prostředí. Projekci však nelze interpretovat jako rekonstrukci skutečně obsazeného areálu, protože model nezohledňuje rozsah zalednění, dobovou vegetaci, dostupnost půd ani disperzní omezení. Naproti tomu projekce do holocenního klimatického optima ukazovala téměř úplné omezení vhodných podmínek, současně však právě tato projekce vykazovala rozsáhlé oblasti vysokých hodnot Shape. Závěr o silné kontrakci během teplého holocenního období je proto ekologicky možný, ale jeho intenzita je málo spolehlivá, protože model byl aplikován na kombinace podmínek vzdálené současným trénovacím datům.

Budoucí projekce shodně naznačovaly postupné omezování a fragmentaci vhodných podmínek, přičemž rozdíly mezi emisními scénáři byly menší v období 2041–2070 a výraznější v období 2071–2100. Nejméně výrazný úbytek byl předpovězen ve scénáři SSP1-2.6, zatímco při SSP3-7.0 a zejména SSP5-8.5 zůstávaly na konci století pouze malé izolované oblasti vyšší vhodnosti v horských polohách. Směr změny je konzistentní s odhadnutými odpověďmi druhu na teplotní a srážkové prediktory, protože oteplování a případné zesílení letního vodního deficitu posouvají budoucí podmínky mimo prostředí spojené se současnými výskyty. Také zde je však nutné oddělit výkon modelu od jistoty projekce: hodnota Somersova D 0,721 vyjadřuje schopnost modelu diskriminovat prostorově oddělená současná testovací data, nikoli jeho ověřenou schopnost předpovídat rozšíření v minulém nebo budoucím klimatu. Metrika Shape navíc ukázala, že environmentální novost v budoucích obdobích roste a že některé oblasti předpovězené jako potenciální refugia leží mimo dobře pokrytou část trénovacího environmentálního prostoru. Vysoká hodnota Shape sama o sobě neprokazuje chybnou predikci, upozorňuje však na statisticky slabě podloženou extrapolaci, jejíž ekologická interpretace musí být opatrná. Nejspolehlivějším závěrem proto není přesná poloha či rozsah budoucího areálu, ale obecný směr změny: klimatické podmínky vhodné pro západobalkánské populace _G. dinarica_ se podle všech analyzovaných scénářů pravděpodobně zmenší a budou stále více omezeny na izolované horské oblasti.
