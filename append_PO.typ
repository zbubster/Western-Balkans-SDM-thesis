...
#figure(
    ...
    image("outputs/ESM/recent_extrapol_weights_all_selected/PO/1000/OOF_prediction.png"),
    image("outputs/ESM/recent_extrapol_weights_all_selected/PO/500/OOF_prediction.png"),
    image("outputs/ESM/recent_extrapol_weights_all_selected/PO/200/OOF_prediction.png"),
    image("outputs/ESM/recent_extrapol_weights_all_selected/PO/100/OOF_prediction.png")
  ),
...
#figure(
  image("outputs/summary/figures/predictor_contributions/recent_extrapol_weights_all_selected/PO/heatmap.png"),
...
#figure(
    ...
    image("outputs/ESM/recent_noextrapol_weights_all_selected/PO/1000/OOF_prediction.png"),
    image("outputs/ESM/recent_noextrapol_weights_all_selected/PO/500/OOF_prediction.png"),
    image("outputs/ESM/recent_noextrapol_weights_all_selected/PO/200/OOF_prediction.png"),
    image("outputs/ESM/recent_noextrapol_weights_all_selected/PO/100/OOF_prediction.png")
  ),
  caption: [Houslové grafy znázorňují rozložení predikcí vhodnosti stanoviště pro pozorované absence a presence druhu v daném prostorovém rozlišení. Jednotlivé body odpovídají predikcím modelu pro konkrétní pozorování, červeně je naznačen median a v popisku celkove Somersovo D celého modelu.]
)

#figure(
  image("outputs/summary/figures/predictor_contributions/recent_noextrapol_weights_all_selected/PO/heatmap.png"),
  caption: [Relativní příspěvek jednotlivých prediktorů do finálního ESM. Jednotlivé příspěvky byly odvozeny z efektivních vah ponechaných bivariátních modelů ve finálním ensemble, přičemž váha každého bivariátního modelu byla rovným dílem rozdělena mezi oba prediktory.]
)
...
#figure(
    ...
    image("outputs/ESM/recent_noextrapol_weights_common/PO/1000/OOF_prediction.png"),
    image("outputs/ESM/recent_noextrapol_weights_common/PO/500/OOF_prediction.png"),
    image("outputs/ESM/recent_noextrapol_weights_common/PO/200/OOF_prediction.png"),
    image("outputs/ESM/recent_noextrapol_weights_common/PO/100/OOF_prediction.png")
  ),
  caption: [Houslové grafy znázorňují rozložení predikcí vhodnosti stanoviště pro pozorované absence a presence druhu v daném prostorovém rozlišení. Jednotlivé body odpovídají predikcím modelu pro konkrétní pozorování, červeně je naznačen median a v popisku celkove Somersovo D celého modelu.]
)
...
#figure(
  image("outputs/summary/figures/predictor_contributions/recent_noextrapol_weights_common/PO/heatmap.png"),
  caption: [Relativní příspěvek jednotlivých prediktorů do finálního ESM. Jednotlivé příspěvky byly odvozeny z efektivních vah ponechaných bivariátních modelů ve finálním ensemble, přičemž váha každého bivariátního modelu byla rovným dílem rozdělena mezi oba prediktory.]
)
